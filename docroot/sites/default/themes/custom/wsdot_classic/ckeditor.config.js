...
CKEDITOR.editorConfig = function(config) {
  ...
  /*
    ...
    */
  config.extraCss = '';
  config.extraCss += ".youtube-player-placeholder{position:relative;width:130px;height:65px;padding-top:15px;padding-left:95px;font-size:13px;font-weight:bold;background:#eee url(https://www.wsdot.wa.gov/sites/default/themes/custom/wsdot_classic/images/youtube-logo.png) left center no-repeat;}";
   ...
   */
  config.templates_files = [Drupal.settings.basePath + 'sites/default/themes/custom/wsdot_classic/js/ckeditor.custom.templates.js'];
