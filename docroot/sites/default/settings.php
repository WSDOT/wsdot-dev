...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_wsdot_dev_default.inc')) {
...
if (isset($_ENV['AH_SITE_ENVIRONMENT'])) {
  ...
  if ($_ENV['AH_SITE_ENVIRONMENT'] == 'LANDO') {
      $conf['file_private_path'] = $files_private_conf_path . '/files-private';
