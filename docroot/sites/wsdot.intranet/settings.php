...
$conf['ah_whitelist'] = array(
  '164.110.0.0-164.110.255.255',
  '198.238.212.0-198.238.213.255',
);
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_wsdot_dev_wsdot_intranet.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_wsdot_dev_wsdot_intranet.inc';
}
// </DDSETTINGS>
